...
for acao in df_top10["ticker"]:
    ...
    # Pega o valor de abertura na data inicial do período
    abertura = df_preco.iloc[-0,-1] 

    # Pega o valor de fechamento na data final do período
...
col = ["ticker", "roic", "earning_yield", 'volume' ] 
df_comparacao = dfplanilhao[col]
    ...
    # Pegor 35 pq vem ações repetidas 
    # Top 35 roic 
